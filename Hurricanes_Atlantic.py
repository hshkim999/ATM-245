...
atlantic_hurricanes = pd.read_csv('/Users/harrykim/Downloads/archive/atlantic.csv')
...
fig_1 = px.bar(described_df,
                 ...
                 title = 'Frequency and Average Wind Speed <br>of Large Storms in Atlantic (1950-2015)',
...
fig_2 = px.bar(described_df_month,
                 ...
                 color = 'Mean',
                 color_continuous_scale=px.colors.sequential.OrRd,
                 title = 'Frequency and Average Max. Wind Speed <br> of Large Storms in Atlantic by Month <br> (1950-2015) <br>',
                 text = 'Mean',
...
fig_num = px.bar(count_df,
                 x='Year',
                 y='Count',
                 title = 'Number of Large Storms in Atlantic by Year (1950-2015)',
